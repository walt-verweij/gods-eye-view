/** Overpass and OSRM route proxy.
 * Outbound guard gap: fixed public mirror and OSRM fetches are not yet routed through it.
 */
import { promises as fsp } from 'node:fs';
import { createHash } from 'node:crypto';
import path from 'node:path';
import { clientKey, makeRateLimiter, readRequestBodyCapped, readResponseTextCapped, registerProxy } from '../shared.mjs';
