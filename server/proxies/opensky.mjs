/** OpenSky states proxy with adsb.lol regional fallback.
 * Outbound guard gap: OpenSky OAuth/state and adsb.lol fallback fetches are not yet routed through it.
 */
import { normalizeAdsbLolPointResponse } from '../../src/data/adsbLolFallback.js';
import { coalesceProxyRequest, readResponseJsonCapped, registerProxy, requiredFiniteQueryNumber } from '../shared.mjs';
