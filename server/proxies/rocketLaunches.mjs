/** Launch Library 2 proxy.
 * Outbound guard gap: this fixed public upstream fetch is not yet routed through it.
 */
import path from 'node:path';
import { promises as fsp } from 'node:fs';
import { coalesceProxyRequest, readResponseTextCapped, registerProxy } from '../shared.mjs';
