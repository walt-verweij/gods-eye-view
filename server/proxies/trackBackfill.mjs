/** Aircraft track-history backfill proxies.
 * Outbound guard gap: OpenSky and adsb.lol track fetches are not yet routed through it.
 */
import { getOpenSkyToken } from './opensky.mjs';
import { readCappedResponseText } from './cctv.mjs';
