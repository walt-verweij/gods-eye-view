...
import { fetchRegionalWeather, regionalBriefHasAnySource, regionalBriefProxy, validRegionalPoint } from './server/proxies/regionalBrief.mjs';
...
function trimWeatherEffectsCache() { while (_weatherEffectsCache.size > WEATHER_EFFECTS_MAX_CACHE) _weatherEffectsCache.delete(_weatherEffectsCache.keys().next().value); }
